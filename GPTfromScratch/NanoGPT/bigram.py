...
class Head(nn.Module):
    ...
    def __init__(self, head_size):
        super().__init__()
        # Key, Query, Value matrices for self attention 
...
print(decode(model.generate(context, max_new_tokens=500)[0].tolist())) # decode the generated sequence of indices to characters
